...
const cardSchema = new mongoose.Schema({
  ...
  type: { type: String },                          // Hệ/Loại (Đấu Sĩ, Hỗ Trợ...)
  ...
  // Bộ 3 kỹ năng
  skills: {
    normal: { name: String, desc: String, type: { type: String, default: 'Đánh thường' } },
    active: { name: String, desc: String, type: { type: String, default: 'Kỹ năng' } },
    ultimate: { name: String, desc: String, type: { type: String, default: 'Tuyệt kỹ' } }
  }
});
